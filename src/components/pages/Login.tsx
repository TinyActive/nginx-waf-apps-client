...
export default function Login() {
  ...
  const [apiIp, setApiIp] = useState(localStorage.getItem('api_ip') || 'localhost');
  const [apiPort, setApiPort] = useState(localStorage.getItem('api_port') || '3001');
              ...
              <>
                <div className="space-y-2">
                  ...
                  <div className="flex space-x-2">
                    ...
                    <Button type="button" onClick={saveApiConfig} variant="outline">
                      Save
                    </Button>
                  </div>
                  <p className="text-xs text-muted-foreground">
                    Configure the backend server IP and port before logging in.
                  </p>
                </div>
                <div className="space-y-2">
